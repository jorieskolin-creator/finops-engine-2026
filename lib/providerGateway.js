...
const fallbackMessage=current=>current.state==='fallback_allowed'&&/^[A-Z][A-Z0-9_]{1,63}$/.test(current.outcome_code||'')?current.outcome_code:String(publicStatus(current.state)).toUpperCase();
