const EVENT_FIELDS = Object.freeze({
  ...
  execution_packet_binding_mismatch: ['run_id', 'attempt_id', 'packet_id_match', 'packet_hash_match', 'content_hash_match', 'run_id_match', 'provider_match', 'model_match', 'stage_match'],
