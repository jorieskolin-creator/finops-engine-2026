const EVENT_FIELDS = Object.freeze({
  ...
  execution_packet_snapshotted: ['run_id', 'attempt_id', 'packet_id', 'stage', 'provider', 'model', 'declared_packet_hash', 'recomputed_content_hash', 'hash_policy_version', 'packet_schema', 'serialized_bytes', 'field_presence_bitmap', 'app_commit', 'deployment_id', 'replica_id', 'node_runtime'],
