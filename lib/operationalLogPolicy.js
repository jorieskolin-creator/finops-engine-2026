...
const EVENT_FIELDS = Object.freeze({
  ...
  maturity_model_shadow_calculated: ['formula_version', 'registry_version', 'corroborated_maturity', 'observed_maturity', 'resolution', 'adjusted_maturity', 'fully_resolved_pairs', 'partially_resolved_pairs', 'unresolved_pairs', 'contradictions', 'scoring_authority'],
