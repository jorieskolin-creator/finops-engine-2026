...
const ROUTES = {
  preflight: [['openai','gpt-5.5'],['openai','gpt-5.4-mini'],['anthropic','claude-sonnet-4-6']],
  forensic_audit: [['anthropic','claude-sonnet-4-6'],['anthropic','claude-haiku-4-5-20251001'],['openai','gpt-5.5'],['anthropic','claude-opus-4-7']],
  targeted_rescan: [['anthropic','claude-opus-4-7'],['openai','gpt-5.5'],['openai','gpt-5.4-mini'],['anthropic','claude-sonnet-4-6']],
  evidence_check: [['openai','gpt-5.5'],['openai','gpt-5.4-mini'],['anthropic','claude-sonnet-4-6'],['anthropic','claude-opus-4-7']],
  evidence_adjudication: [['openai','gpt-5.5'],['openai','gpt-5.4-mini'],['anthropic','claude-opus-4-7'],['anthropic','claude-sonnet-4-6']],
  synthesis: [['anthropic','claude-sonnet-4-6'],['anthropic','claude-haiku-4-5-20251001'],['openai','gpt-5.5'],['openai','gpt-5.4-mini'],['anthropic','claude-opus-4-7']],
  roadmap_synthesis: [['anthropic','claude-opus-4-7'],['openai','gpt-5.5'],['openai','gpt-5.4-mini'],['anthropic','claude-sonnet-4-6']],
  synthesis_escalation: [['anthropic','claude-opus-4-7'],['openai','gpt-5.5'],['openai','gpt-5.4-mini'],['anthropic','claude-sonnet-4-6']],
  fact_check: [['openai','gpt-5.5'],['openai','gpt-5.4-mini'],['anthropic','claude-sonnet-4-6']],
  fact_check_high: [['openai','gpt-5.5'],['openai','gpt-5.4-mini'],['anthropic','claude-sonnet-4-6']],
  quality_gate: [['openai','gpt-5.5'],['openai','gpt-5.4-mini'],['anthropic','claude-sonnet-4-6']],
};
