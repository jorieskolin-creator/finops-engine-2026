...
export class ControlPlaneRepository {
  ...
  async terminalRun(id,target,failureCode=null) {
    if (!['completed','failed','deletion_requested'].includes(target)) throw new ControlPlaneError('INVALID_RUN_TRANSITION');
