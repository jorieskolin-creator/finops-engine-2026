...
export const MODEL_ROUTING_POLICY_VERSION = 'provider_stage_routing_v1';
...
const PROFILES = Object.freeze({
  haiku: profile('claude-haiku-4-5-20251001', 'anthropic', { maxTokens: 4096 }),
  sonnet: profile('claude-sonnet-4-6', 'anthropic', { maxTokens: 8192 }),
  opus: profile('claude-opus-4-7', 'anthropic', { maxTokens: 8192 }),
  gpt54MiniLow: profile('gpt-5.4-mini', 'openai', { openaiReasoning: { effort: 'low' }, maxTokens: 4096 }),
  gpt54MiniMedium: profile('gpt-5.4-mini', 'openai', { openaiReasoning: { effort: 'medium' }, maxTokens: 12000 }),
  gpt54MiniQuality: profile('gpt-5.4-mini', 'openai', { openaiReasoning: { effort: 'medium' }, maxTokens: 8192 }),
  gpt55Low: profile('gpt-5.5', 'openai', { openaiReasoning: { effort: 'low' }, maxTokens: 4096 }),
...
const PROVIDER_STAGE_PROFILES = Object.freeze({
  ...
  OPENAI: Object.freeze({
    preflight: PROFILES.gpt54MiniLow,
...
const LEGACY_ROUTES = Object.freeze({
  preflight: [PROFILES.gpt55Low, PROFILES.sonnet],
