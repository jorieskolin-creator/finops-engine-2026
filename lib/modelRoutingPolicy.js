...
const PROFILES = Object.freeze({
  sonnet: profile('claude-sonnet-5', 'anthropic', { maxTokens: 16384 }),
  opus: profile('claude-opus-5', 'anthropic', { maxTokens: 16384 }),
  gpt54MiniQuality: profile('gpt-5.4-mini', 'openai', { openaiReasoning: { effort: 'medium' }, maxTokens: 16384 }),
  gpt56SolHigh: profile('gpt-5.6-sol', 'openai', { openaiReasoning: { effort: 'high' }, maxTokens: 32768 }),
...
const PROVIDER_STAGE_PROFILES = Object.freeze({
  ...
  OPENAI: Object.freeze({
    forensic_audit: PROFILES.gpt56SolHigh,
    targeted_rescan: PROFILES.gpt56SolHigh,
    evidence_check: PROFILES.gpt56SolHigh,
    evidence_adjudication: PROFILES.gpt56SolHigh,
    synthesis: PROFILES.gpt56SolHigh,
    roadmap_synthesis: PROFILES.gpt56SolHigh,
    synthesis_escalation: PROFILES.gpt56SolHigh,
    fact_check: PROFILES.gpt56SolHigh,
    fact_check_high: PROFILES.gpt56SolHigh,
...
const LEGACY_ROUTES = Object.freeze({
  forensic_audit: [PROFILES.sonnet, PROFILES.gpt56SolHigh, PROFILES.opus],
  targeted_rescan: [PROFILES.opus, PROFILES.gpt56SolHigh, PROFILES.sonnet],
  evidence_check: [PROFILES.gpt56SolHigh, PROFILES.sonnet, PROFILES.opus],
  evidence_adjudication: [PROFILES.gpt56SolHigh, PROFILES.opus],
  synthesis: [PROFILES.sonnet, PROFILES.gpt56SolHigh, PROFILES.opus],
  roadmap_synthesis: [PROFILES.opus, PROFILES.gpt56SolHigh, PROFILES.sonnet],
  synthesis_escalation: [PROFILES.opus, PROFILES.gpt56SolHigh, PROFILES.sonnet],
  fact_check: [PROFILES.gpt56SolHigh, PROFILES.sonnet],
  fact_check_high: [PROFILES.gpt56SolHigh, PROFILES.sonnet],
  quality_gate: [PROFILES.gpt54MiniQuality, PROFILES.sonnet],
});
