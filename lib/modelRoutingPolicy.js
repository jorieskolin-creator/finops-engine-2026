...
export const MODEL_ROUTING_POLICY_VERSION = 'ai_role_routing_v1';
...
const ROLE_PROVIDER_PROFILES = Object.freeze({
  REASONER: Object.freeze({
    ...
    XAI: profile('grok-4.5', 'xai', { reasoningEffort: 'high', maxTokens: 32768 }),
  }),
  WORKHORSE: Object.freeze({
    ...
    XAI: profile('grok-4.5', 'xai', { reasoningEffort: 'medium', maxTokens: 16384 }),
  }),
...
export function resolveModelRouting(env = process.env) {
  ...
  const routes = Object.fromEntries(MODEL_STAGES.map(stage => [stage, roles[STAGE_ROLES[stage]].profiles]));
  return {
