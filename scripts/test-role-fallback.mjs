...
const env = {
  ...
  REASONER_FALLBACK_PROVIDER: 'XAI', REASONER_FALLBACK_MODEL: 'grok-4.5',
  WORKHORSE_PROVIDER: 'ANTHROPIC', WORKHORSE_MODEL: 'claude-sonnet-5',
  WORKHORSE_FALLBACK_PROVIDER: 'XAI', WORKHORSE_FALLBACK_MODEL: 'grok-4.5',
  QUALITY_CHECKER_PROVIDER: 'XAI', QUALITY_CHECKER_MODEL: 'grok-4.5',
