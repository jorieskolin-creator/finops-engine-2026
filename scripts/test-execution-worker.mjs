...
class Repo{
  constructor(state='queued'){this.a={attempt_id:'a',run_id:'run-1',packet_id:packet.packet_id,packet_hash:packet.packet_hash,provider:'openai',model:'gpt-5.6-sol',stage:'forensic_audit',state,run_state:'active',created_at:new Date(),effective_expires_at:new Date(Date.now()+60e3),absolute_deadline_at:new Date(Date.now()+60e3),lease_token:0};}
