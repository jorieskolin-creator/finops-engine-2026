...

{
  ...
  const packet={
    ...
    packet_id:'packet',packet_hash:'hash',run_id:'run',stage:'preflight',provider:'openai',model:'model',
  ...
  try{
    await assert.rejects(
      ()=>callModel({id:'model',provider:'openai',maxTokens:100},{userText:'safe'},'preflight',{runId:'run'}),
