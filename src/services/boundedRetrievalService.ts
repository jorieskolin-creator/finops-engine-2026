...
export const applyBoundedRetrieval=(registry:SourceRegistry,baselinePackets:Record<string,RoutedSourcePacket>):{packets:Record<string,RoutedSourcePacket>;trace:BoundedRetrievalTrace}=>{
...
export const buildBoundedRetrievalTrace=(registry:SourceRegistry,packets:Record<string,RoutedSourcePacket>):BoundedRetrievalTrace=>applyBoundedRetrieval(registry,packets).trace;
